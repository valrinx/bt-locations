...
class BugattiThemeTests(unittest.TestCase):
    def test_theme_is_loaded_after_existing_styles(self):
        self.assertLess(INDEX.index("auth.css?v=7.5.5"), INDEX.index("redesign.css?v=7.5.5"))
        self.assertLess(
            INDEX.index("redesign.css?v=7.5.5"),
            INDEX.index("bugatti-theme.css?v=7.5.5"),
        )
    ...
    def test_release_assets_are_versioned_and_cached(self):
        self.assertIn("const APP_VERSION = 'v7.5.5';", APP)
        self.assertIn("bt-locations-v7.5.5", SW)
