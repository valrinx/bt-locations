...
- Supabase Auth — ต้องเข้าสู่ระบบก่อนใช้แผนที่, สมาชิกใหม่เริ่มเป็น Viewer
...
1. เมื่อเปิดเว็บโดยยังไม่มี session ระบบจะแสดงหน้าเข้าสู่ระบบก่อนเปิดแผนที่
2. เข้าสู่ระบบ หรือสมัครสมาชิกด้วยอีเมลและรหัสผ่านอย่างน้อย 8 ตัวอักษร
3. สมาชิกใหม่เริ่มเป็น Viewer อ่านแผนที่ได้ แต่ยังแก้ข้อมูลไม่ได้
